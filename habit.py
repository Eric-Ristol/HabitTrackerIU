...
class Habit:
    ...
    def __init__(self, habit_name, description, periodicity,creation_date):
    ...
    def create(self,habit_name, description, periodicity,creation_date):

        db.insert_habit(habit_name, description, periodicity,creation_date)
    ...
    def check_off_today(self,habit_name,periodicity):

        today = datetime.today().strftime("%Y-%m-%d")
        check_off_date = today
        db.create_intermediate_dates_checkoff_table(habit_name, check_off_date)
        db.check_off(habit_name, check_off_date,periodicity)
        db.show_check_off(habit_name,check_off_date,periodicity)
        return True
    


    def check_off_date(self,habit_name,check_off_date,periodicity):
